...
def _extract_signatures_from_docstrings(
    docstrings: list[list[str]], /, props: _ItemProperties, tab_width: int,
) -> list[_FormattedSignature]:
    signatures: list[_FormattedSignature] = []
...
_METACLASS_CALL_BLACKLIST = frozenset({"enum.EnumType.__call__",})


# Types whose __new__ signature is a pass-through.
_CLASS_NEW_BLACKLIST = frozenset({"typing.Generic.__new__",})
