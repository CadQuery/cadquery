...
.. note::
    ...
    You may want to work through these examples by pasting the code in CQ-editor (or any other mean of displaying CadQuery models) .
    If you do, make sure to take these steps so that they work:

       1. import cadquery as cq
       2. add the line 'show_object(result)' (only true for CQ-editor) at the end. The samples below are autogenerated, but they use a different
