...
ShapeHistory = dict[Shape | str, Shape]
...
def _process_sewing_history(
    builder: BRepBuilderAPI_Sewing, faces: list[Face], history: ShapeHistory | None,
):
    """
...
@multidispatch
def solid(
    s1: Shape, *sn: Shape, tol: float = 1e-6, history: ShapeHistory | None = None,
) -> Compound | Solid:
    """
...
@multimethod
def sweep(
    s: Shape, path: Shape, aux: Shape | None = None, cap: bool = False
) -> Shape:
    """
...
@multimethod
def sweep(
    s: Sequence[Shape], path: Shape, aux: Shape | None = None, cap: bool = False
) -> Shape:
    """
